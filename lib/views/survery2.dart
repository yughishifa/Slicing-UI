...
class SurveryScreen2 extends StatefulWidget {
  const SurveryScreen2({super.key});

  @override
  State<SurveryScreen2> createState() => _HydroPomeQuizScreen2State();
}

class _HydroPomeQuizScreen2State extends State<SurveryScreen2> {
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context) {
    return AppBar(
      ...
      leading: IconButton(
        ...
        onPressed: () => Navigator.of(context).pop('/survey'), 
      ),
      title: const Text(
        '2/3', 
    ...
    return Padding(
      ...
      child: ElevatedButton(
        onPressed: _isComplete
            ? () {
                Navigator.of(context).pushReplacementNamed('/survey3'); 
              }
            : null, 
